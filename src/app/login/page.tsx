...
export default function Login() {
    return (
        <main className="min-h-screen flex items-center justify-center px-4 py-8 bg-neutral-900">
            <div className="w-full flex flex-col max-w-md space-y-6 bg-neutral-800 p-10 rounded-lg shadow-md">
                <BackToHome />
                ...
                <form className="space-y-4 gap-4">
                    ...
                    <div className="flex gap-4 flex-col">
                        <button
                            type="submit"
                            className="w-full p-3 border cursor-pointer hover:-translate-y-1 border-neutral-700 bg-blue-600 hover:bg-blue-700 text-white rounded transition"
                        >
                            Login
                        </button>
