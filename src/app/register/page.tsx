            ...
            <div className="w-full max-w-md space-y-6 bg-neutral-800 p-10 rounded-lg shadow-md">
                ...
                <form className="space-y-4">
                    ...
                    <label className="block text-xs text-neutral-400">
                        <span className="text-red-500">*</span> By creating an account, you agree to{' '}
                    ...
                    <button
                        type="submit"
                        className="w-full mt-2 p-3 border border-neutral-700 bg-blue-600 hover:bg-blue-700 text-white rounded transition"
                    >
                        Create Account
                    </button>
